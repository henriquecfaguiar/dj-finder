...
<template>
  ...
  >
    <div>
      ...
      <h4 class="mb-1 font-bold text-yellow-300">{{ `$${rate}/hour` }}</h4>
    ...
    <div class="actions flex flex-col gap-4">
      <RouterLink
        class="w-28 rounded-md border-2 border-yellow-300 bg-yellow-300 p-2 text-center text-xs text-slate-900 shadow-lg duration-200 hover:bg-transparent hover:text-yellow-300 md:w-44 md:text-sm"
        :to="djContactLink"
        >Contact</RouterLink
      >
      <RouterLink
